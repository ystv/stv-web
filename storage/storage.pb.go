...
type Ballot struct {
	...
	Election uint64            `protobuf:"varint,2,opt,name=election,proto3" json:"election,omitempty"`
...
func (x *Ballot) GetElection() uint64 {
	if x != nil {
		return x.Election
	}
	return 0
...
func (x *Candidate) GetElection() uint64 {
	if x != nil {
		return x.Election
	}
	return 0
...
var file_storage_proto_rawDesc = []byte{
	...
	0x6c, 0x6f, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52,
	0x02, 0x69, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	...
	0x20, 0x01, 0x28, 0x04, 0x52, 0x08, 0x65, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x12,
